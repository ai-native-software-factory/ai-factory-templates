...
| 文件 | 内容 | 可信度 | 相关文档 |
|------|------|--------|---------|
| 知识库-商业模式画布.md | **必读**：B2B2C、激活码商业道具 | 中 | 激活、直播课 |
| 知识库-学生使用旅程.md | **必读**：学生端到端流程 | 中 | 激活、作业、AI评测 |
| 知识库-业务概念词汇表.md | 核心概念总表 | 高 | 全部 |
| 知识库-机构账号产品数据模型.md | 完整 ER 图 | 高 | 商业模式 |
| 知识库-激活与授权.md | 激活码 + 7种类型 | 高 | 商业模式、蓝思测评 |
| 知识库-直播课(airclass).md | 直播课全流程 | 高 | 商业模式 |
| 知识库-Lexile分值体系.md | 蓝思自适应测评 | 高 | 蓝思测评 |
| 知识库-蓝思测评.md | **新增**：Lexile 独立数据库架构 | 高 | Lexile分值体系 |
| 知识库-分销系统.md | 三级分销佣金体系 | 高 | 商业模式 |
| 知识库-作业与练习.md | 两套作业系统 | 中 | 学生旅程 |
| 知识库-财务与对账.md | 新旧两套财务体系 | 中 | 商业模式 |
| 知识库-题库.md | 按蓝思值随机抽题 | 中 | 蓝思测评 |
| 知识库-内容制作.md | 模板 CI/CD 流水线 | 高 | 题库 |
| 知识库-打卡营.md | 旧版打卡营 | 中 | 学习营 |
| 知识库-学习营.md | **新增**：新版学习营 stage 机制 | 中 | 电子图书馆 |
| 知识库-电子书与图书馆.md | 7种激活码类型 | 中 | 蓝思测评 |
| 知识库-电子图书馆.md | **新增**：绘本分类/级别体系 | 中 | 学习营、打卡营 |
| 知识库-用户中心.md | **新增**：邀请 + 访客追踪 | 中 | 分销（对比） |
| 知识库-AI评测.md | **新增**：余额制 AI 评测 | 中 | 激活、lexile |
| 知识库-测评试卷.md | **新增**：测评试卷 CRUD | 中 | 蓝思测评 |
| 知识库-业务知识框架.md | 5个核心业务问题 | - | 技术团队参考 |
| 知识库-系统架构全景.md | 技术架构（降级） | - | 技术团队参考 |

---

*文档版本: v1.2（新增9份文档，Lexile 独立数据库重大发现）*
*分析工具: 代码逆向 + service.js 逻辑抽取*
*可信度: 高=直接读源码，中=逻辑推断，低=需验证*
